<header>
    ...
    <ul class="nav-links">
        <li><a href="index.php#statistiques">Stats</a></li>
    ...
    <a class="connexion-link" href="login.php"><img src="images/icon.png" alt="Se connecter" width="70px" height="auto" id="profil-icon"></a>
</header>